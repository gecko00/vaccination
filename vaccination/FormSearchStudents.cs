...
{
    public partial class FormSearchStudents : Form
    {
        ...
        private void buttonAccept_Click(object sender, EventArgs e)
        {
            ...
            {
                group = "groupKEY = " + comboBoxGroup.SelectedValue;
            }

            if (checkBoxHealthGroup.Checked == true)
            {
                healthGroup = "physicalEducationHealthGroupKEY = " + comboBoxHealthGroup.SelectedValue;
            }

            if (checkBoxStatus.Checked == true)
            {
                status = "studentStatusKEY = " + comboBoxStatus.SelectedValue;
            }
        ...
        private void FormSearchStudents_Load(object sender, EventArgs e)
        {
